...
from torch.nn.functional import scaled_dot_product_attention as flash_attn_varlen_func_fa3
...
flash_attn_with_kvcache = flash_attn_varlen_func #flash_attn_with_kvcache_fa3
